...
-- สถานะระบบลัดเลาะขอบ (เปลี่ยนจากจำ XZ เป็นจำแกน Y แทน)
_G.TraceState = {
    Active = false,
    Locked = false,
        ...
        pcall(function()
            ...
            if myHuman and myRoot then
                ...
                if _G.TraceState.Locked and _G.TraceState.LockedTargetY then
                    -- เช็คว่าเป้าหมายกระโดดตกลงไป หรือปีนขึ้นไปอีกชั้น
                                    ...
                                    if hDist < 15 then
                                        ...
                                        if checkCeilingAround(currentPos, requiredHeightCheck) then
                                            ...
                                            if edgeStart then
                                                ...
                                                _G.TraceState.LockedTargetY = targetPos.Y -- จำความสูงของเป้าหมาย
